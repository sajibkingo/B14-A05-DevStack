        ...
        <div className='container mx-auto min-h-120 my-4 flex justify-center items-center mb-15'>
            <div className="flex flex-col justify-between  space-y-6">
                ...
                <div className="flex gap-4 mt-8">
                    <button className="bg-linear-to-r from-[#F97316] to-[#EC4899] text-white font-medium px-6 rounded-lg shadow-sm hover:opacity-95 transition-opacity cursor-pointer">
            ...
            <div>
                <img src={BannerLogo} alt="" className="w-120 
                h-105 object-cover"/>
            </div>
        </div>
    );
